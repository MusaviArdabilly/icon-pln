...
class InnovationSeeder extends Seeder
{
    ...
    public function run(): void
    {
        Idea::create([
            ...
            'title' => '<p>inv Strategi Penerapan Teknologi Hybrid Power System pada PLN untuk Meningkatkan Ketersediaan Energi Listrik</p>',
            ...
            'content' => '<p>Hybrid Power System pada PLN Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>',
            ...
            'total_views' => 0,
            'total_comments' => 0,
            'created_at' => '2023-09-15 14:07:53',
        ]);
        Idea::create([
            'user_id' => 1,
            'thumbnail' => 'thumbnails/default-tumbnail-idea.png',
            ...
            'total_views' => 0,
            'total_comments' => 0,
            'created_at' => '2023-10-22 14:07:53',
        ]);
        Idea::create([
            'user_id' => 1,
            'thumbnail' => 'thumbnails/default-tumbnail-idea.png',
            ...
            'total_views' => 0,
            'total_comments' => 0,
            'created_at' => '2023-10-26 14:07:53',
        ]);
        Idea::create([
            'user_id' => 1,
            'thumbnail' => 'thumbnails/default-tumbnail-idea.png',
        ...
        Idea::create([
            ...
            'total_views' => 0,
            'total_comments' => 0,
            'created_at' => '2023-11-19 14:07:53',
        ]);
        Idea::create([
            'user_id' => 1,
            'thumbnail' => 'thumbnails/default-tumbnail-idea.png',
            ...
            'total_views' => 0,
            'total_comments' => 0,
            'created_at' => '2023-12-20 14:07:53',
        ]);
        Idea::create([
            'user_id' => 2,
            'thumbnail' => 'thumbnails/default-tumbnail-idea.png',
            ...
            'content' => '<p>Distribusi PLN is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>',
            ...
            'total_views' => 0,
            'total_comments' => 4,
            'created_at' => '2024-01-01 11:07:53',
        ]);
        Idea::create([
            'user_id' => 2,
            'thumbnail' => 'thumbnails/default-tumbnail-idea.png',
        ...
        Idea::create([
            ...
            'total_views' => 0,
            'total_comments' => 4,
            'created_at' => '2024-01-02 14:07:53',
        ]);
        Idea::create([
            'user_id' => 2,
            'thumbnail' => 'thumbnails/default-tumbnail-idea.png',
