                ...
                <div class="comment-container rounded p-3">
                  ...
                  <div class="comment-content mx-2 pt-1">
                    <div class="d-flex justify-content-between align-items-center mb-1">
                      ...
                      <div class="mx-3">|</div>
                      <a href="/admin/idea/{{ $idea->id }}/comment/{{ $comment->id }}/delete" class="cursor-pointer" onclick="deleteComment(event, '{{ $comment->user->name }}')">
...
<script>
  ...
  function deleteComment(event, username) {
    event.preventDefault();
    var redirectTo = event.currentTarget.getAttribute('href');
    window.Swal.fire({
      title: `Hapus Komentar dari ${username} ?`,
      text: 'Apakah anda yakin untuk menghapus komentar terkait?',
      icon: 'warning',
      reverseButtons: true,
      showCancelButton: true,
      cancelButtonText: 'Batal',
