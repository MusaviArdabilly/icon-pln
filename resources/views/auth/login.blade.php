      ...
      <form method="POST" action="/login/post">
        ...
        <div class="mb-3">
          ...
          @if ($errors->has('password'))
              <span class="pl-3 text-danger"><small>{{ $errors->first('password') }}</small></span>
          @endif
        </div>
        <div class="mb-3">
          ...
          <div class="form-group">
            <div class="captcha d-flex">
              <input type="text" name="captcha" class="form-control me-2">
              <img id="captcha-image" src="{{ captcha_src(); }}" alt="Captcha" class="rounded me-2">
          ...
          @if ($errors->has('captcha'))
              <span class="pl-3 text-danger"><small>{{ $errors->first('captcha') }}</small></span>
          @endif
        </div>
