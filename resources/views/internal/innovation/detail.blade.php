      ...
      <div class="row mb-5">
        <div class="col-12 d-md-none">
          <div class="tumbnail-desktop">
            <img src="{{ asset('storage/' . $innovation->thumbnail) }}" alt="">
          </div>
        </div>
        <div class="col-12 col-md-9">
          <h1 class="d-none d-md-block fs-36 fw-600 text-overflow-hidden" data-mdb-toggle="popover" title="{{ strip_tags($innovation->title) }}">{!! $innovation->title !!}</h1>
                  ...
                  <div class="comment-container rounded p-3">
                    ...
                    <div class="comment-content mx-2 pt-1">
                      <div class="d-flex justify-content-between align-items-center mb-1">
                        ...
                        <div class="fs-14 ms-5 btn-reply" onclick="showComment({{ $comment->user->id }}, {{ $innovation->id }}, {{ $comment->id }})"><i class="d-inline fs-20 bi bi-reply-fill"></i>Balas</div>
                      </div>
